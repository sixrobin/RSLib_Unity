namespace RSLib.Framework.GUI
{
    ...
    /// <summary>
    /// Enhancements for native Unity Toggle component, mostly useful to add events for pointer enter
    /// exit and click event. Also adds an option to deselect toggle when clicked.
    /// </summary>
