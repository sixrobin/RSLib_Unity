...
#if UNITY_EDITOR
        [SerializeField]
        private List<GameObject> _listenersGameObjects = null;
#endif
        
        private readonly HashSet<IUIVisibleEventListener> _listeners = new HashSet<IUIVisibleEventListener>();
        private readonly Dictionary<IUIVisibleEventListener, bool> _listenersRegisteredVisible = new Dictionary<IUIVisibleEventListener, bool>();
        private readonly Dictionary<IUIVisibleEventListener, Canvas[]> _listenersCanvases = new Dictionary<IUIVisibleEventListener, Canvas[]>();
