namespace RSLib.Extensions
{
	...
	public static class StackExtensions
	{
		...
		/// <summary>
		/// Writes the stack elements in a string.
		/// </summary>
		...
		public static string ToStringImproved<T>(this Stack<T> stack)
		{
			...
			{
				++elementIndex;
				str += element.ToString() + (elementIndex == stack.Count ? string.Empty : ", ");
			}
		...
		/// <summary>
		/// Writes the stack elements in a string using a given splitting char.
		/// </summary>
		/// <param name="stack">Stack to write.</param>
		...
		public static string ToStringImproved<T>(this Stack<T> stack, char split)
		{
			...
			{
				++elementIndex;
				str += element.ToString() + (elementIndex == stack.Count ? string.Empty : split.ToString());
			}
		...
		/// <summary>
		/// Writes the stack elements in a string using a given splitting string.
		/// </summary>
		/// <param name="stack">Stack to write.</param>
		...
		public static string ToStringImproved<T>(this Stack<T> stack, string split)
		{
			...
			{
				++elementIndex;
				str += element.ToString() + (elementIndex == stack.Count ? string.Empty : string.IsNullOrEmpty(split) ? " / " : split);
			}
