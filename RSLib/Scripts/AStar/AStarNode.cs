namespace RSLib.AStar
{
	...
	/// Holds informations about the pathfinding, along with some events and the node's world position.
	/// </summary>
	public abstract class AStarNode : Framework.Collections.IHeapElement<AStarNode>
	{
		...
		/// <summary>World position of the node, used for gameObjects path follow.</summary>
		...
		/// <summary>One by default, increase the value to make the node more expensive during the A* research.</summary>
		public int BaseCost { get; set; }

        /// <summary>Node will be ignored during the A* research if this is false.</summary>
		...
		/// <summary>Sets the mesh in which the node is belonging and adds listeners to this mesh events.</summary>
		...
		/// <summary>Called when a new node is added to the holding mesh.</summary>
