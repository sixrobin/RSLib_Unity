namespace RSLib.Audio
{
    public abstract class ClipProvider : UnityEngine.ScriptableObject, IClipProvider
    {
        ...
        private UnityEngine.Audio.AudioMixerGroup _mixerGroup = null;
        [UnityEngine.SerializeField, UnityEngine.Range(0f, 1f)]
        private float _volumeMultiplier = 1f;
        [UnityEngine.SerializeField, UnityEngine.Range(-4f, 2f)]
