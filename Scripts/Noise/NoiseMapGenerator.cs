namespace RSLib.Noise
{
    ...
    public class NoiseMapGenerator : MonoBehaviour
    {
        ...
        [Header("REFS")]
        [SerializeField]
        private NoiseTextureRendererUtilities _noiseMapView = null;
        ...
        [Header("COLORS")]
        [SerializeField]
        private ColorMode _colorMode = ColorMode.NOISE_MAP;
        [SerializeField]
        private Color _heightMapColorA = Color.white;
        [SerializeField]
        ...
        {
            float[,] noiseMap = Noise.GenerateNoiseMap(_size, _noiseScale, _seed, _octaves, _persistence, _lacunarity, _offset);
