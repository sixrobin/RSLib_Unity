namespace RSLib.Unity.Framework.InputSystem
{
    ...
    {
        [SerializeField]
        private InputMapDatas _defaultMapDatas = null;
        [SerializeField]
        private bool _disableMapLoading = false;
        [SerializeField]
        private bool _autoLoadOnStart = true;
        [SerializeField]
        private KeyCode[] _cancelAssignKeys = null;
        [SerializeField]
        private KeyCode[] _unbindableKeys = null;
