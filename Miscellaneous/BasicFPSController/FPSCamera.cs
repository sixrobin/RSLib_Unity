namespace RSLib.FPSController
{
    ...
    public class FPSCamera : FPSControllableComponent
    {
        ...
        [SerializeField]
        private float _pitchSpeed = 120f;
        [SerializeField]
        private float _yawSpeed = 145f;
        [SerializeField]
        private float _height = 1.8f;
        [SerializeField]
        private float _crouchedHeight = 0.7f;
        [SerializeField]
        private float _addForward = 0.15f;
        [SerializeField]
        private bool _yAxisReversed = false;
        ...
        [Header("EXTRAS")]
        [SerializeField]
        private FPSCameraExtraMovement[] _extraMovements = null;
