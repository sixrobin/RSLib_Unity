namespace RSLib.FPSController
{
    ...
    public class FPSHeadBob : FPSCameraExtraMovement
    {
        ...
        [SerializeField]
        private float _idleAmplitude = 0.3f;
        [SerializeField]
        private float _idleSpeed = 0.35f;
        [SerializeField] 
        private float _walkingAmplitude = 0.3f;
        [SerializeField]
        private float _walkingSpeed = 0.3f;
        [SerializeField]
        private float _crouchedAmplitude = 0.25f;
        [SerializeField]
        private float _crouchedSpeed = 0.2f;
        [SerializeField]
        private float _sprintingAmplitude = 0.55f;
        [SerializeField]
        private float _sprintingSpeed = 0.7f;
        [SerializeField]
        private float _bobDamping = 0.3f;
        [SerializeField, Range(0f, 1f)]
        private float _crouchWalkPercentage = 0.5f;
