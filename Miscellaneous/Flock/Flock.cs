namespace RSLib.Unity.Flock
{
    ...
    public class Flock : MonoBehaviour
    {
        ...
        [Header("REFS")] 
        [SerializeField]
        private FlockAgent _flockAgentPrefab = null;
        [SerializeField]
        private FlockBehaviour _flockBehaviour = null;
        [SerializeField]
        private Transform _center = null;
        [SerializeField]
        private FlockAgent[] _startingAgents = null;
        
        [Header("AGENTS BEHAVIOUR")]
        [SerializeField, Range(0, 500)]
        private int _startingCount = 100;
        [SerializeField, Range(1f, 100f)]
        private float _driveFactor = 10f;
        [SerializeField, Range(1f, 100f)]
        private float _maxSpeed = 5f;
        [SerializeField, Range(1f, 10f)]
        private float _neighbourRadius = 1.5f;
        ...
        private void Update()
        {
            for (int i = _agents.Count - 1; i >= 0; --i)
            {
                ...
                //// Debug visualizer.
                // agent.GetComponentInChildren<SpriteRenderer>().color = Color.Lerp(Color.white, Color.magenta, _context.Count / 10f);
