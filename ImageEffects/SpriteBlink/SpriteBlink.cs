namespace RSLib.ImageEffects
{
    ...
    public class SpriteBlink : MonoBehaviour
	{
		...
		private float _colorFadeDur = 0.08f;
		
		#if ODIN_INSPECTOR
		[FoldoutGroup("Color Blink")]
		#endif
		[SerializeField, Min(0f)]
		private float _coloredDur = 0.05f;
		
		#if ODIN_INSPECTOR
		[FoldoutGroup("Color Blink")]
		#endif
		[SerializeField, Min(0f)]
		private float _inBetweenColorBlinksDur = 0.05f;
		
		#if ODIN_INSPECTOR
		[FoldoutGroup("Color Blink")]
		#endif
        [SerializeField, Range(0f, 1f)]
		private float _blinkColorAlpha = 1f;
		...
		#endif
		[SerializeField, Min(0f)]
		private float _alphaFadeDur = 0.08f;
		
		#if ODIN_INSPECTOR
		[FoldoutGroup("Alpha Blink")]
		#endif
		[SerializeField, Min(0f)]
		private float _transparencyDur = 0.05f;
		
		#if ODIN_INSPECTOR
		[FoldoutGroup("Alpha Blink")]
		#endif
		[SerializeField, Min(0f)]
		private float _inBetweenAlphaBlinksDur = 0.05f;
